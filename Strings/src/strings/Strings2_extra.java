...
public class Strings2_extra{
	
	

//Given a string, return a string where for every char in the original, there are two chars.
public String doubleChar1(String str)
{
	int len = str.length();
	char ch;
...
// returning the number of times that "hi" appears anywhere in the given string
...
public int countCode1(String str)
{
	int times = 0;
	int i = 0;
...
public boolean endOther1(String a, String b)
{
	int aLen = a.length();
	int bLen = b.length();
	String end;
...
public boolean xyzThere1(String str)
{
...
public boolean bobThere1(String str)
{
	int len = str.length() - 2;
	for(int i = 0; i < len; i++)
	{
